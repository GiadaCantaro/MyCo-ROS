...
from myco_robot_msgs.srv._myco_iod_read import MycoIODRead_Request, MycoIODRead_Response,MycoIODRead
from myco_robot_msgs.srv._myco_iod_write import MycoIODWrite_Request, MycoIODWrite_Response,MycoIODWrite
from myco_robot_msgs.srv._set_int16 import SetInt16_Request, SetInt16_Response,SetInt16
from myco_robot_msgs.srv._set_string import SetString_Request,SetString_Response,SetString
...
class MyFrame(wx.Frame,Node):  
    ...
    def __init__(self,parent,id):  
        ...
        self.node = rclpy.create_node('myco_basic_gui')
        self.gui_node = rclpy.create_node('myco_gui_node_test')
 
        the_size=(700, 720) # height from 550 change to 700
        wx.Frame.__init__(self,parent,id,'Myco Control Panel',pos=(250,100)) 
        ...
        self.controller_ns="myco_arm_controller/"
        self.myco_driver_ns='myco_ros_control/myco/'
        self.myco_IO_ns='myco_ros_control/myco/io_port1/' # 20201126: add IO ns

        self.publisher_ = self.node.create_publisher(Float32, 'vel', 10)

        self.call_read_do_req = MycoIODRead_Request() # MycoIODReadRequest()
        self.call_read_di_req = MycoIODRead_Request() # MycoIODReadRequest()
        self.call_read_do_req.data = True
        self.call_read_di_req.data = True
        self.call_read_do = self.node.create_client(MycoIODRead, '/read_do')
        self.call_read_di = self.node.create_client(MycoIODRead, '/read_di')

        # 20201126: add service for write_do
        self.call_write_DO=self.node.create_client(MycoIODWrite, '/write_do')
        
        self.myco_basic_api_ns='myco_basic_api/'
        ...
        self.node.declare_parameter(self.controller_ns+"joints", ["myco_joint1","myco_joint2","myco_joint3","myco_joint4","myco_joint5","myco_joint6"])
        ...
        self.end_link_name="myco_end_link" # self.group.get_end_effector_link()
        ...
        self.btn_path = os.path.dirname(os.path.realpath(__file__)) # 20201209: get the myco_gui.py path
        btn_lengths=[]
        ...
        if self.use_fake_robot:
            self.call_power_on=self.node.create_client(SetBool,'/myco_basic_api/enable_robot')
        else:
        ...
        if self.use_fake_robot:
            self.call_power_off=self.node.create_client(SetBool,'/myco_basic_api/disable_robot')
        else:
    ...
    def call_write_DO_command(self, event, marker, client):
        ...
        write_request = MycoIODWrite_Request()
        request = 0
        try:
    ...
    def listen(self):
        ...
        self.myco_gui_executor = MultiThreadedExecutor()
