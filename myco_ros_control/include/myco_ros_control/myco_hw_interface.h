#ifndef MYCO_ROS2_CONTROL_HW_INTERFACE
#define MYCO_ROS2_CONTROL_HW_INTERFACE
...
typedef struct{
    myco_ethercat_driver::MycoEtherCATClient* client_ptr;
    AxisInfo axis1;
    AxisInfo axis2;
}ModuleInfo;
...
public:
  ...
  RCLCPP_SHARED_PTR_DEFINITIONS(MycoHWInterface)
...
private:
  ...
  std::vector<std::string> myco_driver_names_;
  myco_ethercat_driver::EtherCatManager* em;
  std::vector<myco_ethercat_driver::MycoEtherCATDriver*> ethercat_drivers_;
